function [ quad ] = quad_pos( pos, rot, L, P, H )
...
% P         3x1 [L_leg; L_propeller; H_propeller]
...
quadBodyFrame  = [L 0 0 1; 0 L 0 1; -L 0 0 1; 0 -L 0 1; 0 0 0 1; 0 0 H 1; L 0 -P(1) 1; 0 L -P(1) 1; -L 0 -P(1) 1; 0 -L -P(1) 1;]';
