classdef QuadPlot < handle
    ...
    methods
        % Constructor
        function Q = QuadPlot(qn, state, wingspan, propeller, height, color, max_iter, h_3d)
            Q.qn = qn;
            Q.state = state;
            Q.wingspan = wingspan;
            ...
            Q.motor = quad_pos(Q.state(1:3), Q.rot, Q.wingspan, Q.propeller, Q.height);
            ...
            %
            Q.h_ml1 = plot3(Q.h_3d, ...
                Q.motor(1, [1 7]), ...
                Q.motor(2, [1 7]), ...
                Q.motor(3, [1 7]), ...
                '-kx', 'MarkerFaceColor', Q.color, 'MarkerSize', 5);
            Q.h_ml2 = plot3(Q.h_3d, ...
                Q.motor(1, [2 8]), ...
                Q.motor(2, [2 8]), ...
                Q.motor(3, [2 8]), ...
                '-kx', 'MarkerFaceColor', Q.color, 'MarkerSize', 5);
            Q.h_ml3 = plot3(Q.h_3d, ...
                Q.motor(1, [3 9]), ...
                Q.motor(2, [3 9]), ...
                Q.motor(3, [3 9]), ...
                '-kx', 'MarkerFaceColor', Q.color, 'MarkerSize', 5);
            Q.h_ml4 = plot3(Q.h_3d, ...
                Q.motor(1, [4 10]), ...
                Q.motor(2, [4 10]), ...
                Q.motor(3, [4 10]), ...
                '-kx', 'MarkerFaceColor', Q.color, 'MarkerSize', 5);
        ...
        function UpdateQuadPlot(Q, state, des_state, time)
            ...
            set(Q.h_ml3, ...
                ...
                'ZData', Q.motor(3,[3 9]));
            set(Q.h_ml4, ...
                'XData', Q.motor(1,[4 10]), ...
                'YData', Q.motor(2,[4 10]), ...
                'ZData', Q.motor(3,[4 10]));
