classdef QuadPlot < handle
    ...
    properties (SetAccess = public)
        ...
        color;          % color of quad
        wingspan;       % wingspan
        propeller;      % propeller location matrix [L_leg L_propeller H_propeller]
    ...
    properties (SetAccess = private)
        ...
        h_ml1;  % motor 1 and leg handle
        h_ml2;  % motor 2 and leg handle
        h_ml3;  % motor 3 and leg handle
        h_ml4;  % motor 4 and leg handle
    ...
    methods
        ...
        function Q = QuadPlot(qn, state, wingspan, height, color, max_iter, h_3d)
            ...
            Q.des_state = Q.state(1:12);

            Q.max_iter = max_iter;
            Q.state_hist = zeros(10, max_iter);     % x,y,z, xd,yd,zd, w1,w2,w3,w4 
            Q.state_des_hist = zeros(12, max_iter); % pos, vel, acc, jerk
        ...
        function UpdateQuadHist(Q)
            ...
            Q.state_hist(:,Q.k) = [Q.state(1:6); Q.state(14:17)];
            Q.state_des_hist(:,Q.k) = Q.des_state(1:12);
        end
